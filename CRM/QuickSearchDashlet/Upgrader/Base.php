 ...
 */
class CRM_QuickSearchDashlet_Upgrader_Base {
  ...
  static public function instance() {
    if (! self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_QuickSearchDashlet_Upgrader(
        'org.civicoop.quicksearchdashlet',
        realpath(__DIR__ .'/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_QuickSearchDashlet_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
